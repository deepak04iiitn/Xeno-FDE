      ...
      <div className="max-w-md w-full">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-10 border border-slate-200/80 animate-in fade-in zoom-in-95 duration-300">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-600">Get started with Xeno</p>
          </div>
          ...
          <p className="mt-7 text-center text-sm text-slate-600">
            ...
            <Link to="/sign-in" className="text-indigo-600 font-semibold hover:text-indigo-700 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
